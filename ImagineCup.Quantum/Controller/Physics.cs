...
namespace ImagineCup.Quantum.Model
{
    public class Physics
    {
        ...
        private List<GameObject> removeStack = new List<GameObject>();
        int Width = 0;
        int Height = 0;
        ...
        public Physics(List<GameObject> objects, List<GameObject> quant, int width, int height) {
            Width = width;
            Height = height;
            bodies = objects;
            this.quant = quant;
        ...
        private void task() {
            foreach (GameObject obj1 in quant)
            {
                ...
                if (obj1.m_x < 0 ||
                    ...
                    obj1.m_y < 0 ||
                    obj1.m_y > Height)
                    removeStack.Add(obj1);
            }
            //foreach (GameObject obj in removeStack)
              //  obj.delete();
        }
